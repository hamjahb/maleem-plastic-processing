...
Order.create(customer_name: "Center Point", film_width: 45, height: 45, material: "HD", specifications: "courier bag", size: "M", order_weight_kg: 45000, thickness: 60, masterbatch: "white" )


Order.create(customer_name: "Sun and Sands", film_width: 25, height: 50, material: "LD", specifications: "punch shopping bag", size: "S", order_weight_kg: 200000, thickness: 40, )
