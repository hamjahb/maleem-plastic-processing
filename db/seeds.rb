...
Roll.create(order_id: 1, machine_number: 6, roll_weight: 400, operator_name: "mojo jo jo", qa_sample_weight: 40 )


Roll.create(order_id: 2, machine_number: 6, roll_weight: 234, operator_name: "HIM", qa_sample_weight: 46 )


Roll.create(order_id: 1, machine_number: 2, roll_weight: 350, operator_name: "Fuzzy Lumpkins", qa_sample_weight: 46 )


Roll.create(order_id: 1, machine_number: 3, roll_weight: 274, operator_name: "Gang Green Gang", roll_print_complete: true, printed_weight:252, qa_sample_weight: 23 )


Roll.create(order_id: 3, machine_number: 2, roll_weight: 560, operator_name: "Gang Green Gang", roll_print_complete: true, printed_weight:540, qa_sample_weight: 34 )
